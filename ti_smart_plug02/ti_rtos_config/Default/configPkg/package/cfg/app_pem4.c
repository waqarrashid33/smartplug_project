...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[6030];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/waqar/workspace/ti_smart_plug02/ti_rtos_config/Default/configPkg/package/cfg/app_pem4");
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x178e;
